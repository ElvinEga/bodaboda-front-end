                    ...
                    if (err) {
                        ...
                        if ($rootScope.stepDirection && $rootScope.distanceCheck) {
                            ...
                            if (res <= taxiData.company.firstKm) {
                                ...
                                statusBarContent = taxiData.company.companyName + " : " + res + " Km - Earlier :" + taxiData.company.firstPrice + " KSH";

                            } else if (res <= taxiData.company.middleKm) {
                                statusBarContent = taxiData.company.companyName + " : " + res + " Km - Earlier :" + Math.round(taxiData.company.firstPrice + ((res - taxiData.company.firstKm ) * taxiData.company.middlePrice)) + " KSH";
                            } else {
                                statusBarContent = taxiData.company.companyName + " : " + res + " Km - Earlier :" + $filter('currency')(Math.round(taxiData.company.firstPrice
                                    + (taxiData.company.middleKm - taxiData.company.firstKm) * taxiData.company.firstPrice
                                    + (res - taxiData.company.middleKm) * taxiData.company.lastPrice), "KSH");
                            }
